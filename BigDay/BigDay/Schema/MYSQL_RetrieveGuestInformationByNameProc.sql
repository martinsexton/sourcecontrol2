DELIMITER //
Create procedure RetrieveGuestInformationByName
	(in p_firstname nvarchar(50),in p_surname nvarchar(50))
begin
	...
	where source.firstname = p_firstname and source.surname = p_surname
